...
const PROVIDER = {
  name: "openrouter",
  model: "openrouter/free", // auto-picks a currently-free model; pin a specific one from openrouter.ai/models?max_price=0 for more consistency
  endpoint: "https://openrouter.ai/api/v1/chat/completions",
  apiKeyEnvVar: "OPENROUTER_API_KEY"
};

// Same project used by the storefront — reading business_info here uses
// the public anon key, which is safe since that table is public-readable.
